        ...
        <div className="support-wrapper">
          <div className="support-app">
            ...
            <div className="support-card-container">
              <div className="card" onClick={() => alert('Clicked Account Settings :D')}>
              <FaUser className='support-icon'/>
                <p className="support-label">Account Settings</p>
              </div>
              <div className="card" onClick={() => alert('Clicked Password Reset XD')}>
              <FaKey className='support-icon'/>
                <p className="support-label">Password Reset</p>
              </div>
              <div className="card" onClick={() => alert('Clicked Contact Settings :P')}>
              <FaEnvelope className='support-icon'/>
                <p className="support-label">Contact Settings</p>
              </div>
            </div>
            <div>
